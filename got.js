function regras() {
    ...
    /* facts from the family tree of the Targaryen family */

    /* parent(aemon_targaryen, NO SON). */
    /**/
    parent(aegon_v_targaryen, duncan_targaryen).
    parent(aegon_v_targaryen, aerys_ii_targaryen).
    parent(aegon_v_targaryen, rhaella_targaryen).
    parent(aegon_v_targaryen, daeron_targaryen).
    /**/
    /* parent(aerion_targaryen, NO SON). */
    /**/
    ...
    /**/
    /* parent(euron_greyjoy, NO SON).
    /**/
    /* parent(aeron_greyjoy, NO SON).

    /* facts from the family tree of the Baratheon family */
    ...
    /* facts from the family tree of the Tyrell family */
    ...
    /* facts from the family tree of the Martell family */
    ...
    /* facts from the family tree of the Tully family */

    parent(robbyrt_tully, hoster_tully).
    parent(robbyrt_tully, brynden_tully).
    /**/
    parent(hoster_tully, catelyn_tully).
    parent(hoster_tully, lysa_tully).
    parent(hoster_tully, edmure_tully).

    /* facts from the family tree of the Arryn family */
